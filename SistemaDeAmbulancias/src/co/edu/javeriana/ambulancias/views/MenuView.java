...
public class MenuView extends JPanel 
{
	...
	public void guardarDatos()
	{
		...
		fileChooser.setDialogTitle("Especifique el nombre para guardar el archivo sin extensi�n");
		...
		if(userSelection == JFileChooser.APPROVE_OPTION)
		{
			...
			if(IsSuccess)
			{
				JOptionPane.showMessageDialog(ventanaPrincipal, "Se ha guardado con �xito los datos!", "�xito", JOptionPane.INFORMATION_MESSAGE);
			}
			else 
			{
	...
	public void cargarDatos()
	{
		...
		if(fileChooser.showOpenDialog(ventanaPrincipal) == JFileChooser.APPROVE_OPTION)
		{
			...
			if (empresaAmbulanciasTemp != null)
			{
				...
				JOptionPane.showMessageDialog(ventanaPrincipal
						, "Se han cargado con �xito los datos!"
						, "�xito"
